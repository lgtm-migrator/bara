import { BaraPortion, ChainBase } from '.'
...
export type VirtualAction<T> = (...chain: ChainBase[]) => VirtualActionConfig<T>
...
export const popEvent = <T, C, M>(
  ...
  const createFlowAction = (flowName: string) => (...chain: ChainBase[]) => {
