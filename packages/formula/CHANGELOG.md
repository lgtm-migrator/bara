...
* **formula:** concurrent not work expected with primitives value ([77d89c6](https://github.com/barajs/bara/commit/77d89c6))
...
* **formula:** add selectArg formula ([3ffabe4](https://github.com/barajs/bara/commit/3ffabe4))
...
* **formula:** add concurrent function for map ([25faf95](https://github.com/barajs/bara/commit/25faf95))
...
* **formula:** if statement should return the result ([4620fdb](https://github.com/barajs/bara/commit/4620fdb))
